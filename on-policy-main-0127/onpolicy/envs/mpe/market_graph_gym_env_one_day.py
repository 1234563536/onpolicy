...
class MA_ELEC_Market_Graph_ENV(gym.Env):
    ...
    def step(self, actions):
        ...
        for i in range(self.agent_num-1):
            ...
            if self.action_state[self.agent_selection][0] < -self.Pes_max[i]:
                self.action_state[self.agent_selection][0] = -self.Pes_max[i]
            self.action_state[self.agent_selection][1] = ((action[1] + 1) / 2) * self.L_max_i[i]*0.8
            if self.action_state[self.agent_selection][1] > self.L_max_i[i]*0.8:
                self.action_state[self.agent_selection][1] = self.L_max_i[i]*0.8
            ...
            if self.s_l_state[self.agent_selection] > self.sl_sum[i]:
                self.action_state[self.agent_selection][3] = self.action_state[self.agent_selection][3] - self.s_l_state[self.agent_selection] + self.sl_sum[self.agent_selection]
        ...
        PN = [(self.P_u[agent]/1e4) - (self.tr_dic[i] /1e4) for agent in self.agents[:-1]]
