...
def get_config():
    ...
    Env parameters:
        ...
        -- train_month <bool>
            True: use 30days-env
            False: use 1-day-env or use run mode
    ...
    Run data parameters
        --use_run
            by default False, do not open the run data mode. If set, only run data.
        --run_model_dir
            by default None. set the path to trained model file.
        --run_tag
            by  default None. set the tag for each run data
    """
    ...
    parser.add_argument("--user_name", type=str, default='marl',help="[for wandb usage], to specify user's name for "
                                                                     "simply collecting training data.")
    parser.add_argument("--use_wandb", action='store_false', default=False, help="[for wandb usage], by default True, "
                                                                                 "will log date to wandb server. or "
                                                                                 "else will use tensorboard to log "
                                                                                 "data.")
    ...
    parser.add_argument("--train_month", type=int,
                        default=0, help="1: use 30-days-env;  0: use 1-day-env for train or use run data mode")
    '''
    # replay buffer parameters
    ...
    # 0127 run data parameters
    parser.add_argument("--use_run", action='store_true', default=False,
                        help="by default, do not start evaluation. If set`, start evaluation alongside with training.")
    parser.add_argument("--run_model_dir", type=str, default = r'/results/Market/simple_speaker_listener/mappo/check/run',
                        help="by default None. set the path to pretrained model.")
    parser.add_argument("--run_tag", type=str,
                        default = None,
                        help = "by default None. set the tag for each run data.")
    return parser
# /Users/mac/Documents/项目/电工所/第一个合同/on-policy-0127/results/Market/simple_speaker_listener/mappo/check/run32/models/